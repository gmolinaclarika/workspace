IF EXISTS(SELECT * FROM sysobjects WHERE name = 'desktopfx$station_get' AND type = 'P')
    DROP PROCEDURE desktopfx$station_get
GO
...
sp_procxmode desktopfx$station_get, "anymode"
GO
