IF EXISTS(SELECT * FROM sysobjects WHERE name = 'desktopfx$profile_get' AND type = 'P')
    DROP PROCEDURE desktopfx$profile_get
GO
...
sp_procxmode desktopfx$profile_get, "anymode"
GO
