IF EXISTS(SELECT * FROM sysobjects WHERE name = 'desktopfx$object_dir' AND type = 'P')
    DROP PROCEDURE desktopfx$object_dir
GO

CREATE PROCEDURE desktopfx$object_dir
--------------------------------------------------------------------------------
...
sp_procxmode desktopfx$object_dir, "anymode"
GO
