...
IF EXISTS(SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'dbo.EcuACCPRV') AND type in (N'U'))
    DROP TABLE dbo.EcuACCPRV
GO
IF EXISTS(SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'dbo.EcuACCLOG') AND type in (N'U'))
    DROP TABLE dbo.EcuACCLOG
GO
IF EXISTS(SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'dbo.EcuACCCTX') AND type in (N'U'))
    DROP TABLE dbo.EcuACCCTX
GO
IF EXISTS(SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'dbo.EcuACCCON') AND type in (N'U'))
    DROP TABLE dbo.EcuACCCON
GO
IF EXISTS(SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'dbo.EcuACCC2P') AND type in (N'U'))
    DROP TABLE dbo.EcuACCC2P
GO
IF EXISTS(SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'dbo.EcuACCC2U') AND type in (N'U'))
    DROP TABLE dbo.EcuACCC2U
GO
IF EXISTS(SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'dbo.EcuACCCAP') AND type in (N'U'))
    DROP TABLE dbo.EcuACCCAP
GO
IF EXISTS(SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'dbo.EcuACCU2P') AND type in (N'U'))
    DROP TABLE dbo.EcuACCU2P
GO
IF EXISTS(SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'dbo.EcuACCUSU') AND type in (N'U'))
    DROP TABLE dbo.EcuACCUSU
GO
IF EXISTS(SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'dbo.EcuACCPER') AND type in (N'U'))
    DROP TABLE dbo.EcuACCPER
GO
IF EXISTS(SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'dbo.EcuACCNET') AND type in (N'U'))
    DROP TABLE dbo.EcuACCNET
GO
IF EXISTS(SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'dbo.EcuACCFAM') AND type in (N'U'))
    DROP TABLE dbo.EcuACCFAM
GO
