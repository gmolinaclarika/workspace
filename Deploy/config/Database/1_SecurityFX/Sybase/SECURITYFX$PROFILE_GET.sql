IF EXISTS(SELECT * FROM sysobjects WHERE name = 'securityfx$profile_get' AND type = 'P')
    DROP PROCEDURE securityfx$profile_get
GO
...
sp_procxmode securityfx$profile_get, "anymode"
GO
