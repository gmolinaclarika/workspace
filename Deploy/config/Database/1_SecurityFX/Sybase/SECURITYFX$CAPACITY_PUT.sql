IF EXISTS(SELECT * FROM sysobjects WHERE name = 'securityfx$capacity_put' AND type = 'P')
    DROP PROCEDURE securityfx$capacity_put
GO
...
sp_procxmode securityfx$capacity_put, "anymode"
GO
